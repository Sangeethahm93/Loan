...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("profile.additional-details.update") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="lands" class="form-control" id="lands" value="{{ old('no_of_houses', $userAdditionalDetail->lands) }}"/>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="no_of_vehicles" class="form-control" id="no_of_vehicles" value="{{ old('no_of_houses', $userAdditionalDetail->no_of_vehicles) }}"/>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="other_property" class="form-control" id="other_property" value="{{ old('no_of_houses', $userAdditionalDetail->other_property) }}"/>
